...
/**
 * Servlet implementation class ModificarDescuentos
 */
@WebServlet("/ModificarDescuentos")
public class ModificarDescuentos extends HttpServlet implements PageControllerG3 {
